...
#ifndef H_VANILLACASH_SCRIPT
#define H_VANILLACASH_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CVanillacashAddress
 */
...
public:
    ...
    // Pre-version-0.6, Vanillacash always counted CHECKMULTISIGs
