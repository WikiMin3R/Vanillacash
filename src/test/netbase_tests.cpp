...
{
    BOOST_CHECK(TestSplitHost("vanillacash.com", "vanillacash.com", -1));
    BOOST_CHECK(TestSplitHost("[vanillacash.com]", "vanillacash.com", -1));
    BOOST_CHECK(TestSplitHost("vanillacash.com:80", "vanillacash.com", 80));
    BOOST_CHECK(TestSplitHost("[vanillacash.com]:80", "vanillacash.com", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:48884", "127.0.0.1", 48884));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:48884", "127.0.0.1", 48884));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:48884", "::ffff:127.0.0.1", 48884));
    BOOST_CHECK(TestSplitHost("[::]:48884", "::", 48884));
    BOOST_CHECK(TestSplitHost("::48884", "::48884", -1));
    BOOST_CHECK(TestSplitHost(":48884", "", 48884));
    BOOST_CHECK(TestSplitHost("[]:48884", "", 48884));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:48884", "127.0.0.1:48884"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:48884", "[::]:48884"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
