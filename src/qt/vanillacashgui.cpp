 ...
 * The Vanillacash Developers 2020-2021
 */

#include <QApplication>

#include "vanillacashgui.h"
...
VanillacashGUI::VanillacashGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
...
{
    resize(850+95, 550);
    setWindowTitle(tr("Vanillacash") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/vanillacash"));
    setWindowIcon(QIcon(":icons/vanillacash"));
#else
...
void VanillacashGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Vanillacash address"));
    ...
    aboutAction = new QAction(tr("&About Vanillacash"), this);
    aboutAction->setToolTip(tr("Show information about Vanillacash"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Vanillacash"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/vanillacash"), tr("&Show / Hide"), this);
...
void VanillacashGUI::createMenuBar()
{
...
void VanillacashGUI::createToolBars()
{
...
void VanillacashGUI::setClientModel(ClientModel *clientModel)
{
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/vanillacash_testnet"));
            setWindowIcon(QIcon(":icons/vanillacash_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/vanillacash_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Vanillacash client") + QString(" ") + tr("[testnet]"));
...
void VanillacashGUI::setWalletModel(WalletModel *walletModel)
{
...
void VanillacashGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
    ...
    trayIcon->setToolTip(tr("Vanillacash client"));
...
#ifndef Q_OS_MAC
void VanillacashGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void VanillacashGUI::optionsClicked()
{
...
void VanillacashGUI::aboutClicked()
{
    AboutDialog dlg;
...
void VanillacashGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Vanillacash network", "", count));
}

void VanillacashGUI::setNumBlocks(int count)
{
...
void VanillacashGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("Vanillacash") + " - ";
...
void VanillacashGUI::changeEvent(QEvent *e)
{
...
void VanillacashGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void VanillacashGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(VanillacashUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void VanillacashGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
        ...
        notificator->notify(Notificator::Information,
                            (amount)<0 ? tr("Sent transaction") :
                              ...
                              tr("Date: %1\n"
                                 ...
                                 "Address: %4\n")
                              .arg(date)
                              .arg(VanillacashUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                              .arg(type)
                              .arg(address), icon);
    }
}

void VanillacashGUI::gotoOverviewPage()
{
...
void VanillacashGUI::gotoHistoryPage()
{
...
void VanillacashGUI::gotoAddressBookPage()
{
...
void VanillacashGUI::gotoBlockBrowser(QString transactionId)
{
...
void VanillacashGUI::gotoReceiveCoinsPage()
{
...
void VanillacashGUI::gotoSendCoinsPage()
{
...
void VanillacashGUI::gotoSignMessageTab(QString addr)
{
...
void VanillacashGUI::gotoVerifyMessageTab(QString addr)
{
...
void VanillacashGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void VanillacashGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Vanillacash address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void VanillacashGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void VanillacashGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void VanillacashGUI::encryptWallet()
{
    if(!walletModel)
        return;
...
void VanillacashGUI::backupWallet()
{
...
void VanillacashGUI::changePassphrase()
{
...
void VanillacashGUI::unlockWallet()
{
    if(!walletModel)
        return;
...
void VanillacashGUI::lockWallet()
{
    if(!walletModel)
        return;
...
void VanillacashGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void VanillacashGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void VanillacashGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
void VanillacashGUI::updateStakingIcon()
{
    updateWeight();
...
void VanillacashGUI::detectShutdown()
{
