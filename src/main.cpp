...
#if defined(NDEBUG)
# error "Vanillacash cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge =  3 * 60 * 60; // 3 Hour Minimum Stake 
...
const string strMessageMagic = "Vanillacash Signed Message:\n";
    ...
    const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, unsigned int flags)
{
    ...
    // fMiner is true when called from the internal vanillacash miner
...
{
    RenameThread("vanillacash-loadblk");
