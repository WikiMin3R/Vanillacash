...
contains(VANILLACASH_NEED_QT_PLUGINS, 1) {
    DEFINES += VANILLACASH_NEED_QT_PLUGINS
...
HEADERS += src/qt/vanillacashgui.h \
...
SOURCES += src/qt/vanillacash.cpp src/qt/vanillacashgui.cpp \
...
# also add new translations to src/qt/vanillacash.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/vanillacash_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/vanillacash-qt.rc
...
windows:RC_FILE = src/qt/res/vanillacash-qt.rc
